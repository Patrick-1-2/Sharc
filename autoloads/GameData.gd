...
const UPGRADE_CATALOG: Array = [
	{ "id": 0, "name": "Tank Expansion",   "base_cost": 500,  "cost_scale": 2.0, "max_level": 5, "effect": "shark_capacity",     "value": 2,   "description": "Adds 2 shark slots to the sanctuary."        },
	{ "id": 1, "name": "Feeding Station",  "base_cost": 800,  "cost_scale": 2.5, "max_level": 5, "effect": "passive_currency",   "value": 50,  "description": "Adds 50 passive currency per second."         },
	{ "id": 2, "name": "Coral Decoration", "base_cost": 600,  "cost_scale": 3.0, "max_level": 4, "effect": "currency_mult",      "value": 1.1, "description": "Multiplies all currency income by x1.1."      },
	{ "id": 3, "name": "Research Lab",     "base_cost": 2000, "cost_scale": 4.0, "max_level": 3, "effect": "egg_discovery_rate", "value": 1.2, "description": "Multiplies egg discovery rate by x1.2."       },
]

static func upgrade_cost(upgrade: Dictionary, times_purchased: int) -> int:
	return int(upgrade.base_cost * pow(upgrade.cost_scale, times_purchased))
